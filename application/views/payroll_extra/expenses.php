...
<div class="row-fluid">
	<div class="span3" id="content-main-buttons">
		<?=uif::linkInsertButton('payroll_extra/insert_expense')?>
	</div>
	<div class="span9 text-right" id="content-main-filters">
		<?=form_open('payroll_extra/search_expenses','class="form-inline"')?>
...
<script>
	$(function(){
		...
		$("select[name=payroll_extra_cat_fk]").select2({placeholder:'Категорија'});
	});	
</script>