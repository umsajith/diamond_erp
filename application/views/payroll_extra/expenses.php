...
<div class="filers"> 
    <?php echo form_open('payroll_extra/search_expenses');?>
	...
	<tr>
		...
		<?php foreach ($columns as $col_name => $col_display):?>
			<th <?php if($sort_by==$col_name) echo "class=$sort_order";?>>
    			<?php echo anchor("payroll_extra/expenses/$query_id/$col_name/".(($sort_order=='desc' && $sort_by==$col_name)?'asc':'desc'),$col_display);?>
			</th>
    	<?php endforeach;?>
		<th>&nbsp;</th>
	</tr>
