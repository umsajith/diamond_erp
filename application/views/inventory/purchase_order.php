...
<hr>
	...
	<div id="buttons">
		<a href="<?php echo site_url('inventory/edit/por/'.$master->id);?>" class="button"><span class="edit">Корекција</span></a>
		<a href="<?php echo site_url('inventory/delete/por/'.$master->id);?>" class="button" id="delete"><span class="delete">Бришење</span></a>
	</div>	
<hr>
	<dl>
		<dt>Нарачано:</dt>
